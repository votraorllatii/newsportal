...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>News V-Portal | Shto një postim</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Edito një postim </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Posto një foto</b></h4>
<img src="postimages/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
<br />
<a href="change-image.php?pid=<?php echo htmlentities($row['postid']);?>">Përditëso një foto</a>
</div>
</div>
</div>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Përditësoje </button>
