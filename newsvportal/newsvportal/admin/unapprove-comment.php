...
if($_GET['action']=='del' && $_GET['rid'])
{
	...
	$delmsg="Komenti u fshie pergjithmonë. ";
}
...
<html lang="en">
    <head>
        ...
        <title> News V-Portal | Menagjo kategoritë</title>
                                                    ...
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary" style="border: 2px solid #36404e;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="background-color:#36404e!important;"> Emri</th>
                                                                <th style="background-color:#36404e!important;">Id e email-it</th>
                                                                <th width="300" style="background-color:#36404e!important;">Komenti</th>
                                                                 <th style="background-color:#36404e!important;">Statusi</th>
                                                                <th style="background-color:#36404e!important;">Lajmi</th>
