...
<html lang="en">
    <head>
        ...
        <title> News V-Portal | Managjo nën kategoritë</title>
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li>
                                            <a href="#">Nën kategoria </a>
                                        </li>
                                        <li class="active">
                                           Managjo nën kategorinë
                                        </li>
                                    </ol>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light" style="background-color: #36404e!important;border: 1px solid #36404e!important;">Shto <i class="mdi mdi-plus-circle-outline" ></i></button>
</a>
 </div>

												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary" style="border: 2px solid #36404e;">
                                                        <thead>
                                                            <tr>
                                                                <th style="    background-color: #36404e;"></th>
                                                                <th style="    background-color: #36404e;"> Kategoria</th>
                                                                <th style="    background-color: #36404e;">Nën kategoria</th>
                                                                <th style="    background-color: #36404e;">Përshkrimi</th>
                                                          
                                                                <th style="    background-color: #36404e;">Data e postimit</th>
                                                                  <th style="    background-color: #36404e;">Data e përditësimit të fundit</th>
                                                                <th style="    background-color: #36404e;">Aksion</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
<?php 
...
<td colspan="7" align="center"><h3 style="color:red">Nuk u gjend asnjë e dhënë</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Nën kategoritë e fshira</h4>

 </div>

<div class="table-responsive">
   <table class="table m-0 table-colored-bordered table-bordered-danger" style="border: 2px solid #36404e;">
                                                        <thead>
                                                            <tr>
                                                                <th style="    background-color: #36404e;"></th>
                                                                <th style="    background-color: #36404e;"> Kategoria</th>
                                                                ...
                                                                <th style="    background-color: #36404e;">Data e postimit</th>
                                                                  <th style="    background-color: #36404e;">Data e fundit e përditësimit</th>
                                                                <th style="    background-color: #36404e;">Kthe/Fshij</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
<?php 
