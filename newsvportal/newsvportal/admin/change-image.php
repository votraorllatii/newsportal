...
if($query)
{
$msg="Fotoja u perditesua ";
}
else{
$error="Provoni edhe njehere.";    
} 
}
}
?>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Përditëso foton </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Fotoja aktuale e postimit</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Përditëso </button>
</form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
