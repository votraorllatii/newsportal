...
$msg="Fajlëkalimi u nderrua.";
}
}
else
{
$error="Fjalëkalimi i vjetër nuk u përshtat.";
}
}
...
<html lang="en">
    <head>
        ...
        <title>News V-Portal | Ndrysho fjalëkalimin</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Ndrysho fjalëkalimin </b></h4>
                                    <hr />
...
<label class="col-md-4 control-label">Fjalëkalimi aktual</label>
<div class="col-md-8">
