...
if($query)
{
$msg="Kategoria u krijua. ";
}
else{
$error="Diqka shkoi gabim. Provo edhe nje here! ";    
} 
}
...
<html lang="en">
    <head>
        ...
        <title>News V-Portal | Shto kategori</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Shto një kategori </b></h4>
                                    <hr />
