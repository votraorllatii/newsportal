...
<html lang="en">
    <head>
        ...
        <title>News V-Portal | Shto një nën kategori</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Shto një nën kategori </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Përshkrimi për nën kategorinë</label>
	                                                <div class="col-md-10">
